...
PREFIX: process.env.PREFIX || "download view once.",
// add your prifix for bot

BOT_NAME: process.env.BOT_NAME || "sammy xᴅ v2✦",
// add bot name here for menu

CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
// make this true for custum emoji react   

STICKER_NAME: process.env.STICKER_NAME || "✦sammy-XD✦",
...
OWNER_NAME: process.env.OWNER_NAME || "sammy  ᴛᴇᴄʜ🪀✦",
// add bot owner name
...
MODE: process.env.MODE || "public-inbox-private-group",
